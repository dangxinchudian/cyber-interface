...
// $fontname = $pdf->addTTFfont('msyh.ttf', 'TrueTypeUnicode', '', 12);
// $fontname = $pdf->addTTFfont(dirname(__FILE__).'../Droid Sans Fallback.ttf', 'TrueTypeUnicode', '', 12);
// $pdf->SetFont($fontname, '', 40);
// $pdf->SetFont('cid0cs', '', 40);
